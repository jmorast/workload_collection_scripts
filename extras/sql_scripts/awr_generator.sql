...
--  #                                                                         #
--  # Modified by hankwojteczko@davidkentconsulting.com                       #
--  #                                                                         #
--  # 1) Set default output to html format                                    #
--  # 2) Set default output SQL script name to my_awr_report.sql              #
--  #                                                                         #
--  # END MODIFICATIONS hankwojteczko@davidkentconsulting.com                 #
--  #                                                                         $
...
define DEFAULT_OUTPUT_FILENAME = 'my_awr_report.sql'
define NO_ADDM = 0
