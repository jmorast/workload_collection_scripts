...
CREATE TABLE scala_data_00 (
   section NUMBER NOT NULL,
   id1     NUMBER NOT NULL,
   id2     NUMBER NOT NULL
);

INSERT INTO scala_data_00
SELECT sections.n, gen.x, CEIL(DBMS_RANDOM.VALUE(0, 100)) 
 ...
 CREATE INDEX scale_slow ON scala_data_00 (section, id1, id2);


BEGIN
     DBMS_STATS.GATHER_TABLE_STATS(null, 'scala_data_00' 
                                       , CASCADE => true);
END;
/
...
CREATE INDEX scale_fast ON scala_data_00 (section, id2, id1);
